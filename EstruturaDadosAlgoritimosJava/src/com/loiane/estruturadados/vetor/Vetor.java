...
public class Vetor {
	...
	private String[] elementos; // Criar Vetor ou Lista de Elementos
	...
	// Aula 02
	/*
	 * // Novo metodo 1-opção public void adiciona (String elemento) { for ( int
	 * i=0; i<this.elementos.length; i++ ) { if (this.elementos [i]==null) {
	 * this.elementos[i]= elemento; break; } } }
	 * 
	 * // 2 opção fazendo pelo tamanho do vetor public void adiciona (String
